...
import com.mgoogle.android.gms.common.internal.ValidateAccountRequest;
...
public abstract class AbstractGmsServiceBroker extends IGmsServiceBroker.Stub {
    ...
    public void getGamesService(IGmsCallbacks callback, int versionCode, String packageName,
            ...
            throws RemoteException {
        Bundle extras = params == null ? new Bundle() : params;
        extras.putString("com.mgoogle.android.gms.games.key.gamePackageName", gamePackageName);
        extras.putString("com.mgoogle.android.gms.games.key.desiredLocale", desiredLocale);
        //extras.putParcelable("com.mgoogle.android.gms.games.key.popupWindowToken", popupWindowToken);
